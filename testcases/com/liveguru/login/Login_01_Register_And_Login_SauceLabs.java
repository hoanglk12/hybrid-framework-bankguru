...
public class Login_01_Register_And_Login_SauceLabs extends BaseTest {
	WebDriver driver;
	
	String email, firstName, lastName, password, confirmPassword;
	
	@Parameters({"url","platform_name","browserName","browser_version"})
	@BeforeClass
	public void initBrowser(String appUrl, String platformName, String browserName, String browserVersion) {
		driver = getBrowser(appUrl, platformName, browserName, browserVersion);
		email = generateEmail();
	}
