...
public class Login_01_Register_And_Login_Selenium_Grid extends BaseTest {
	WebDriver driver;
	...
	@BeforeClass
	public void initBrowser(String appUrl, String browserName, String ipAddress, String portNumber) {
		driver = getBrowserSeleniumGrid(appUrl, browserName, ipAddress, portNumber);
		email = generateEmail();
	}
